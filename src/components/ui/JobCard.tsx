// old path: src/screens/user/JobCard.tsx
// new path: src/components/ui/JobCard.tsx
// Comentario: Se ha movido este componente a la carpeta de UI y se ha actualizado la importación del componente Button.
